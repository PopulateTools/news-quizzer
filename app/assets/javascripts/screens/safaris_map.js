(function() {
  this.App.safaris_map = function(){
    ...
    $('.map_container').velocity({visibility: "visible", translateX: "-50%", scale: "50%", opacity: .5}, {duration: "0"} ).css("visibility", "visible");
