(function() {
  this.App.diamond_map = function(){
    ...
    var question_data = {
      ...
      "setup_classes": [{
        ...
        },
        {
          "class":"selected_oil",
          "filter_by": "sov_a3",
          "values": ['CIV','GHA','MOZ','NGA','SDS','TGO','UGA','COG','LBY','SDN','TUN']
        }
      ]
    }
    ...
    $('.init_inter').on('click', function(e){
      ...
      $('.map_container').velocity({translateX: 0, scale: "100%", opacity: 1}, {duration: "650", complete: function(){$('.give_hint_button').show();}});
      $(this).hide();
    ...
    $('form[data-answers]').on('ajax:success', function(e, data, status, xhr){
      ...
      $results.velocity("transition.bounceIn");
      $(this).hide();
      $('#next-screen').show();
